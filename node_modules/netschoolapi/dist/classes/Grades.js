...
class Grades {
    constructor(credentials) {
        ...
        const [start, end] = (_b = (_a = (0, parseHtml_1.query)(this.raw, "table td:nth-child(2) > span:nth-child(3)")) === null || _a === void 0 ? void 0 : _a.structuredText.match(/((\d{1,2}\.){2}\d{2})/g)) !== null && _b !== void 0 ? _b : [];
        this.range = { start: (0, dateNum_1.str2date)(start), end: (0, dateNum_1.str2date)(end) };
        this.teacher =
            (_d = (_c = (0, parseHtml_1.query)(this.raw, "table td:nth-child(2) > span:nth-child(9)")) === null || _c === void 0 ? void 0 : _c.childNodes[1].text.trim()) !== null && _d !== void 0 ? _d : "";
