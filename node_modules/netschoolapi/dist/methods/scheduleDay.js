...
const ScheduleDay_1 = __importDefault(require("../classes/ScheduleDay"));
...
function default_1(credentials = {}) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const htmlText = yield client
            .post("../asp/Calendar/DayViewS.asp", Client_1.default.formData({
            at,
            ver,
            ...
            .then((res) => res.text());
        return new ScheduleDay_1.default({
